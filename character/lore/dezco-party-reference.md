# Dezco Quick Reference (Party Sheet)
...
| Current location | Saltrock (protection restored; feast over; resting for dawn choice) |
| Travel status | Adventure day 2; staff fell then focus restored; escort vs church city decision by morning |
...
| I accidentally used a simple imbue in Saltrock street fight | I have also used imbue on purpose in the keep goblin fight (still learning) |
| Yua travels with me | Only the King’s Lion and Rilock know; Saltrock party does not |

---

## Family (quick)

| Person | Who | Age | Name means | Colors | One line |
|---|---|---|---|---|---|
| Dolkin | Father | 38 | steadfast of kin | charcoal, iron, bronze | Steady, Dwarven depth, sent me to train to keep me alive |
| Fulfein | Mother | 36 | full fair light | sage, silver, pale gold | Warm Elven grace; Alzenhiem’s center for me |
| Kalhien | Younger brother | 15 | rises in pursuit | ink blue + copper | Restless, proud, does not want to be only “Dezco’s brother” |
| Astiale | Younger sister | 8 | gentle star | rose, cream, sky | Sweet; not born when I left at 8 |

**Surname Knoleburn means:** stream by the knoll  
**Alzenhiem means:** sheltered home under a kind sky
...
| Place | Alzenhiem |
| Type | Small hamlet |
| Vibe | Dirt paths, low roofs, neighbors first, no royal banners |
| Why it matters | What I stand for when I talk about hope |
| Town flag colors | wheat gold, meadow green, earth brown, cream |
| Town flag idea | roof + wheat + lane |

---

## Timeline (memorize this order)
...
| 17 | Saltrock staff fell; storm, crabs, and other creatures attacked |
| 17 | Fought with defenders; missed short bow creature; faceplant in wet muddy gravel; saved by Eden’s arrow |
| 17 | Sealed in keep; troll + goblins; second imbue cleaved goblins; Eden/fire ended troll |
| 17 | Quest for first King’s Lion tomb; library map; Yolon stone dragon; owlbear bridge; tomb focus recovered |
| 17 | Focus restored Saltrock with mayor, Vita, Yeara; feast; choice by dawn: Lyndor or Lořel |
| Now | Resting after feast; foot bruised from cliff fall; Yua and I still need to talk |

---

## Important people (outside family)

| Person | Who they are to me |
|---|---|
| Yua | Ancient being tied to magic; broke a millennia oath to act; watched me since childhood; gave me Hero title; often appears as a small pixie; only Lion + Rilock know she walks with me |
...
| Tomb focus (recovered) | Saltrock quest | Faint glow; purpose unknown at first; mayor + Vita + Yeara restored town protection with it |
...
| Saltrock | Traveling town; staff fell then focus restored; feast tonight; dawn choice pending |
| Saltrock keep / general building | Where townsfolk sheltered; back wall breached by troll; focus set back with Vita and Yeara |
| Saltrock library | Old book with scrappy map to first King’s Lion tomb |
...
**Current dilemma:** escort mayor to Lyndor vs travel with Yeara to Lořel; decide by morning.

---

## My Hero mission (from Yua)

1. Restore magic before it disappears completely
2. Stand against the darkness consuming the world
3. Unite the fractured kingdoms and races
...
3. Pain tolerance and endurance
4. Tactical education
5. Real combat missions (not simulations; death was possible)
...
| Item | Quick fact |
|---|---|
| Why I wear red + black | I have always loved them; deep reason not revealed to me yet |
| My crest | Simple child crest: blade/flame between small parent marks |
| My sigil | One red/black blade or flame mark |
| Crest tradition | Child crest = name + gender + both parents; simpler than parents; unique |
| Sigil tradition | Same day as crest; one quick seal mark |

### Family crest / sigil cheat sheet

| Person | Colors | Crest idea | Sigil idea |
|---|---|---|---|
| Dolkin | charcoal / iron / bronze | stone arch + hammer | hammer in arch |
| Fulfein | sage / silver / pale gold | leaf + crescent | leaf into crescent |
| Dezco | red / black | balanced blade/flame | red/black split blade |
| Kalhien | blue / copper | forward eager mark | forward chevron |
| Astiale | rose / cream / sky | soft bud or star | soft bud/star |

Images: `assets/crests/alzenhiem/`

---

## Secrets / do not spoil yet

Use this when roleplaying what party members know.
...
| Yua walks with me daily | No | Only King’s Lion + Rilock know |
| A divine being was seen in the world | Yes | Public knowledge; not tied to me |
| I talk to empty air when stressed | They saw it | Bridge return; vine excuse worked for now |
| Exact red/black blood meaning | No | Yua will tell me later; I do not know yet |
| Mana Well / Lord AO gift | Partial | Yua named gift in private woods talk; training still ahead |
| Why I hide Yua from them | No | See yua-why-she-stays-hidden.md |
...
**Mana Well truth (for you / DM; Yua explained partially in woods):**  
Mana pool stored within soul confines but separate from the soul. Gift from Lord AO per Yua after tomb road. Simple imbue makes sword lighter/sharper and grants a short agility burst. First accidental use: ~15 ft dash mid swing in street fight. Second use: deliberate cleave through two goblins in keep. Needs training. Yua senses unknown darkness ahead.

**Yua hidden truth (for you / DM):**  
See `character/lore/yua-story-plots/yua-why-she-stays-hidden.md`. Hope must stay on mortal hands, not slide to worship of her presence.
...
| First use | Saltrock street fight (journal 03); accidental ~15 ft dash mid swing = muddy faceplant |
| Second use | Keep goblin fight; cleaved one at waist, gutted another >10 ft away |
| Yua’s explanation | Woods talk after tomb: gift from Lord AO; grow together through training |
| Yua’s warning | Feels a darkness she has never known; source unknown |
| Training needed | Control timing, avoid waste, move with the burst instead of being thrown |
| Yua’s mood | Upset after bridge; said we need to talk later |
...
2. Proud of Alzenhiem without boasting
3. Corrects “Hero of centuries” rumors for the training years
4. Speaks kindly about family, especially Astiale
5. Does not claim to understand Yua fully
6. Prefers no dramatic dash heavy speech; plain and direct

---

## Where the long versions are
...
| Journal 03 (full) | `character/lore/journal/03-saltrock-staff-falls.md` |
| Yua hidden from party | `character/lore/yua-story-plots/yua-why-she-stays-hidden.md` |
...
## Blank lines for new party facts

Add new rows here whenever something new becomes true in play:
