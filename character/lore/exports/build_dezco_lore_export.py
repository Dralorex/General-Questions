...
def build_workbook() -> Path:
    ...
    add_table_sheet(
        ...
        [
            ...
            ["12 to 17", "Real missions; false Hero of centuries rumors"],
            ["Before 15", "Name known across much of the realm"],
            ["17", "Master said training was complete"],
            ["17", "Yua gave ancient title Hero + sacred mission + Mana Well (unexplained)"],
