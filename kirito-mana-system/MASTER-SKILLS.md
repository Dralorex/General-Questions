...
## Master table — tier, prereq, effect
...
| Snake Bite | Utility | One-Handed Sword | Horizontal Arc | 2 attacks · weapon disrupt | Break-style |
| Sharp Nail | Combo | One-Handed Sword | Vertical Arc | 3 melee (+1d4 each) | Progressive |
| Horizontal Square | Mid | One-Handed Sword | Horizontal Arc | 4 melee · +2 AC if all hit | 4-hit square |
| Vertical Square | Mid | One-Handed Sword | Vertical Arc | 4 melee (+1d6 each) | 4-hit square |
| Embracer | Utility | Martial Arts | — | Unarmed +2d8 · ignore nonmag armor | Martial Arts slot @ 8 |
| Vorpal Strike | Power | One-Handed Sword | Sonic Leap | Reach +5 ft · +2d8 · no reaction | Signature thrust |
| Dual Blades (Unique Skill) | Gate | Unique Skill Gate | Vorpal Strike + Reaction Trial | Unlocks dual-wield tree | **Dual lock lifts here** |
| Double Circular | Dual | Dual Blades | Dual Blades (Unique Skill) | Dash 15 ft · 2 dual attacks | First dual tech |
| Cross Block | Defense | Dual Blades | Double Circular | Reaction: disadv on 1 melee · riposte | Uses normal Reaction |
| Meteor Break | Power | Composite | Embracer + Vertical Square | 4d8 + STR · shove 10 ft | Sword + martial |
| Starburst Stream | Ultimate | Dual Blades | Double Circular + Cross Block | 6 attacks +3d8 · vulnerable after | Boss turn |
| The Eclipse | Ultimate | Dual Blades | Starburst Stream | 8 attacks +6d8 · 1/long rest | Peak finisher |
...
### Deflect — 10 mana · Special Reaction
When you are hit by a melee weapon attack or sword skill you can see, spend **10 mana** to force a reroll against AC +2 (or impose disadvantage — pick one table rule and stick to it).
...
| Duration | Almost always Instant |
